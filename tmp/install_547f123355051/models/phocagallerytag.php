...
class PhocaGalleryCpModelPhocaGalleryTag extends JModelAdmin
{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_phocagallery.edit.phocagallerytag.data', array());
